(() => {
  ...
  // https://jsr.io/@http/route/0.9.0-beta.2/as_url_pattern.ts
  ...
  // https://jsr.io/@http/route/0.9.0-beta.2/by_pattern.ts
  ...
  // https://jsr.io/@http/route/0.9.0-beta.2/cascade.ts
  ...
  // https://jsr.io/@http/response/0.9.0-beta.2/plain_error.ts
  ...
  // https://jsr.io/@http/response/0.9.0-beta.2/method_not_allowed.ts
  function methodNotAllowed(message) {
    return plainError(405, "Method Not Allowed", message);
  }

  // https://jsr.io/@http/response/0.9.0-beta.2/no_content.ts
  ...
  // https://jsr.io/@http/response/0.9.0-beta.2/replace_body.ts
  ...
  // https://jsr.io/@http/route/0.9.0-beta.2/by_method.ts
  ...
  // https://jsr.io/@http/response/0.9.0-beta.2/html.ts
  ...
  // https://jsr.io/@http/response/0.9.0-beta.2/prepend_doctype.ts
  ...
  // https://jsr.io/@http/request/0.9.0-beta.2/search_values.ts
