(() => {
  ...
  // https://jsr.io/@http/fns/0.7.0/lib/as_url_pattern.ts
  ...
  // https://jsr.io/@http/fns/0.7.0/lib/by_pattern.ts
  ...
  // https://jsr.io/@http/fns/0.7.0/lib/cascade.ts
  ...
  // https://jsr.io/@http/fns/0.7.0/lib/response/plain_error.ts
  ...
  // https://jsr.io/@http/fns/0.7.0/lib/response/method_not_allowed.ts
  function methodNotAllowed(message) {
    return plainError(405, "Method Not Allowed", message);
  }

  // https://jsr.io/@http/fns/0.7.0/lib/response/no_content.ts
  ...
  // https://jsr.io/@http/fns/0.7.0/lib/response/replace_body.ts
  ...
  // https://jsr.io/@http/fns/0.7.0/lib/by_method.ts
  ...
  // https://jsr.io/@http/fns/0.7.0/lib/response/html.ts
  ...
  // https://jsr.io/@http/fns/0.7.0/lib/response/prepend_doctype.ts
  ...
  // https://jsr.io/@http/fns/0.7.0/lib/request/search_values.ts
